...
const SIGNATURES: &[(&str, &str)] = &[
    ("_dadd", include_str!("../../../assets/signatures/_dadd.yaml")),
    ("_fflt", include_str!("../../../assets/signatures/_fflt.yaml")),
    ("_dflt", include_str!("../../../assets/signatures/_dflt.yaml")),
    ("_dmul", include_str!("../../../assets/signatures/_dmul.yaml")),
    ("_dsub", include_str!("../../../assets/signatures/_dsub.yaml")),
    ("_ll_udiv", include_str!("../../../assets/signatures/_ll_udiv.yaml")),
    ("_s32_div_f", include_str!("../../../assets/signatures/_s32_div_f.yaml")),
    ("_u32_div_f", include_str!("../../../assets/signatures/_u32_div_f.yaml")),
    ("_ddiv", include_str!("../../../assets/signatures/_ddiv.yaml")),
    ("__assert_failed", include_str!("../../../assets/signatures/__assert_failed.yaml")),
    ("__memset_impl", include_str!("../../../assets/signatures/__memset_impl.yaml")),
    ("__destroy_global_chain", include_str!("../../../assets/signatures/__destroy_global_chain.yaml")),
    ("__cxa_vec_ctor", include_str!("../../../assets/signatures/__cxa_vec_ctor.yaml")),
    ("__cxa_vec_cleanup", include_str!("../../../assets/signatures/__cxa_vec_cleanup.yaml")),
    ("__register_global_object", include_str!("../../../assets/signatures/__register_global_object.yaml")),
